...
export const entityManagersService = {
    getEntityManagers: async params => {
        return await axiosInstance.get(API_URLS.ENTITY_MANAGERS.LIST, { params });
    },
    ...
    createEntityManager: async data => {
        return await axiosInstance.post(API_URLS.ENTITY_MANAGERS.CREATE, data);
    },

    updateEntityManager: async (id, data) => {
        return await axiosInstance.post(API_URLS.ENTITY_MANAGERS.UPDATE(id), data);
    },

...
import { termsAndConditionsSchema as schema } from '@/utils/yup/termsAndConditions.schemas';
import React from 'react';
import { termsAndConditionsFields } from './configs';
...
export default function FormTermsAndConditions({
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            {termsAndConditionsFields.map(field => (
                <InputRFH
                    p="px-3 py-3"
                    control={control}
                    register={register}

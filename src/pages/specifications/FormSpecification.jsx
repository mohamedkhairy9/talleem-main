...
import { specificationsSchema as schema } from '@/utils/yup/specifications.schemas';
import React from 'react';
import { specificationsFields } from './configs';
import InputRFH from '@/components/common/inputs/InputRFH';
import Btn from '@/components/common/buttons/Btn';
import { getNestedError } from '@/utils/helpers/getNestedError';

export default function FormSpecification({
    onClose,
    oldData,
    editMode,
    viewMode,
